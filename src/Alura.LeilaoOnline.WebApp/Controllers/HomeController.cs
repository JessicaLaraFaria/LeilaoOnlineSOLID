...
namespace Alura.LeilaoOnline.WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var categorias = service.ConsultaCategoriasComTotalDeLeiloesEmPregao();
        ...
        {
            var categ = service.ConsultaCategoriaPorIdComLeiloesEmPregao(categoria);
            return View(categ);
        }
        ...
        public IActionResult Busca(string termo)
        {
            ...
            var leiloes = service.PesquisaLeiloesEmPregaoPorTermo(termo);
            return View(leiloes);
        }
    }
}
